...
{
	if (PUN_ACTIVE_PAGE != 'pms_new')
	{
		if (file_exists(PUN_ROOT.'style/'.$pun_user['style'].'/reminder.css'))
			$page_head['dhtmlwstyle'] = '<link rel="stylesheet" type="text/css" href="style/'.$pun_user['style'].'/reminder.css" />';
		else
			$page_head['dhtmlwstyle'] = '<link rel="stylesheet" type="text/css" href="style/imports/reminder.css" />';
