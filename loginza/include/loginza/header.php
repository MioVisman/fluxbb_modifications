...
if (!defined('PUN_REGLOG'))
{
	...
	$page_statusinfo = '<p class="conl"><span>'.$lang_common['Not logged in'].'</span>&#160;<a rel="nofollow" href="'.pun_htmlspecialchars($urlLgz).'" class="loginza"><img alt="'.$lang_rl['Loginza reglog'].'" src="'.$btnlgz.'" style="margin-bottom: -0.5em;" /></a></p>';
}
else
