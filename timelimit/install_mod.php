...
function install()
{
	...
	$db->add_field('groups', 'g_deledit_interval', 'INT(10)', false, '0');
	$db->add_field('posts', 'edit_post', 'TINYINT(1)', false, '0');
...
function restore()
{
	...
	$db->drop_field('groups', 'g_deledit_interval');
	$db->drop_field('posts', 'edit_post');
}
